    ...
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content bg-dark text-light" style="background-color: #212529 !important; color: #f8f9fa;">
            ...
            <div class="modal-body">
                ...
                <form id="editProfileForm" method="POST" action="/handlers/profile-edit.handler.php">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control bg-secondary text-light border-0" id="editFirstName"
                            name="first_name" placeholder="<?php echo htmlspecialchars($user_data['first_name']); ?>">
                    </div>
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control bg-secondary text-light border-0" id="editLastName"
                            name="last_name" placeholder="<?php echo htmlspecialchars($user_data['last_name']); ?>">
                    </div>
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control bg-secondary text-light border-0" id="editUsername"
                            name="username" placeholder="<?php echo htmlspecialchars($user_data['username']); ?>">
                    </div>
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control bg-secondary text-light border-0" id="editAddress"
                            name="address" placeholder="<?php echo htmlspecialchars($user_data['address']); ?>">
                    </div>
                    <div class="mb-3">
